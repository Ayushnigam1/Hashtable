...
const Navbar = (props: { mode?: 'sticky' | 'fixed' }) => {
    ...
    return (
        <>
            <Header
                height={64}
                className={`${props.mode != undefined ? props.mode : "fixed"
                    } min-w-full ${onTop ? "dark:text-gray-300 bg-transparent" : "bg-sky-500 text-white"
